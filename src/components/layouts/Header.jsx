...
function Header() {
  ...
  return (
    <nav className="sticky -top-px bg-white text-sm font-medium mb-2 text-black ring-1 ring-gray-900 ring-opacity-5 shadow-sm shadow-gray-100 pt-3 md:pb-3 -mt-px dark:bg-slate-900 dark:border-gray-800 dark:shadow-slate-700/[.7]" aria-label="Jump links">
